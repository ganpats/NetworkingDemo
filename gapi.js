...
function CreateLinksInGame(link_id,tp,key){var url="https://m.shtoss.com";window.open(url);}
...
var d=new String(window.location.host);if(d.indexOf("shtoss.com")==-1&&d.indexOf("localhost")==-1){window.location="https://m.shtoss.com";}
