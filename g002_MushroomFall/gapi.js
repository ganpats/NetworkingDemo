...
function CreateLinksInGame(link_id,tp,key){var url="https://ganpats.github.io/NetworkingDemo/g002_MushroomFall/";window.open(url);}
...
var d=new String(window.location.host);if(d.indexOf("shtoss.com")==-1&&d.indexOf("localhost")==-1&&d.indexOf("h5games.online")==-1){window.location="https://m.shtoss.com";}
...
function dataURItoBlob(dataURI){var byteString=atob(dataURI.split(",")[1]);var ab=new ArrayBuffer(byteString.length);var ia=new Uint8Array(ab);var i=0;for(;i<byteString.length;i++){ia[i]=byteString.charCodeAt(i);}
